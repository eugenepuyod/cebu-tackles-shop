...
<template>
  <div class="cart-page min-h-screen pt-[90px] lg:pt-[100px] bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-5xl mx-auto">
      ...
      <div v-if="isEmpty" class="bg-white rounded-3xl p-16 text-center border border-gray-100 shadow-sm flex flex-col items-center">
        <div class="w-24 h-24 bg-orange-50 text-blue-500 rounded-full flex items-center justify-center mb-6">
        ...
        <router-link to="/shop" class="bg-blue-500 text-white font-bold py-3 px-8 rounded-xl shadow-lg shadow-blue-500/30 hover:bg-blue-600 transition-all hover:scale-[1.02] active:scale-95 inline-flex items-center">
      ...
      <div v-else class="flex flex-col lg:flex-row gap-8">
          ...
          <div v-for="item in cartStore.items" :key="item.cartItemId" class="bg-white p-4 sm:p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col sm:flex-row items-center gap-6 relative group transition-all hover:shadow-md">
            ...
            <div class="flex-1 w-full text-center sm:text-left pt-2 sm:pt-0">
              <div class="flex items-center justify-center sm:justify-start gap-3 mb-1">
                <div class="text-xs font-bold text-blue-500 uppercase tracking-widest">{{ item.category }}</div>
        ...
        <div class="lg:w-1/3">
          <div class="bg-white rounded-2xl border border-gray-100 shadow-xl p-6 lg:p-8 sticky top-24">
            ...
            <router-link to="/checkout" class="w-full bg-blue-500 hover:bg-blue-600 text-white font-bold py-4 rounded-xl shadow-lg shadow-blue-500/30 transition-all flex items-center justify-center hover:scale-[1.02] active:scale-95 text-lg">
              Proceed to Checkout
            </router-link>
            <div class="mt-4 text-center">
              <router-link to="/shop" class="text-gray-500 hover:text-blue-500 text-sm font-medium inline-flex items-center transition-colors">
                Continue Shopping
              </router-link>
            </div>
          </div>
