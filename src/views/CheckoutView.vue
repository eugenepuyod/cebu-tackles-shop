  ...
  <div class="checkout-page pt-35 min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-5xl mx-auto">
      ...
      <div v-if="orderComplete" class="bg-white rounded-3xl p-16 text-center border border-gray-100 shadow-lg max-w-2xl mx-auto flex flex-col items-center transform transition-all">
        ...
        <div class="w-full">
          <router-link to="/" class="inline-flex bg-blue-500 text-white font-bold py-4 px-10 rounded-xl shadow-lg shadow-blue-500/30 hover:bg-blue-600 transition-all hover:scale-[1.02] active:scale-95 text-lg">
            Back to Home
          </router-link>
        </div>
      </div>
      ...
      <div v-else-if="cartStore.items.length === 0 && !orderComplete" class="text-center py-20 bg-white rounded-3xl shadow-sm border border-gray-100">
        ...
        <router-link to="/shop" class="text-blue-500 hover:underline font-medium text-lg">Continue Shopping</router-link>
      </div>
        ...
        <div class="w-full lg:w-2/3 space-y-8">
          ...
          <div class="bg-white rounded-3xl border border-gray-100 shadow-[0_4px_20px_rgba(0,0,0,0.03)] p-6 sm:p-10">
            <h2 class="text-2xl font-bold text-gray-900 mb-8 flex items-center">
              <span class="w-8 h-8 rounded-full bg-blue-500 text-white text-sm flex items-center justify-center mr-3 font-extrabold shadow-md shadow-blue-500/20">1</span>
              Shipping Details
            </h2>
            <form class="space-y-6">
              ...
              <div>
                ...
                <input v-model="user.fullName" type="text" class="w-full px-5 py-4 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none transition-all text-gray-900" placeholder="John Doe">
              </div>

              <div>
                <label class="block text-sm font-bold text-gray-700 mb-2">Email</label>
                <input v-model="user.email" type="text" class="w-full px-5 py-4 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none transition-all text-gray-900" placeholder="Email">
              </div>

              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label class="block text-sm font-bold text-gray-700 mb-2">Phone Number</label>
                  <input v-model="user.phone" type="tel" class="w-full px-5 py-4 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none transition-all text-gray-900" placeholder="+63 9xx xxx xxxx">
                </div>
                <div>
                  <label class="block text-sm font-bold text-gray-700 mb-2">City</label>
                  <input v-model="user.city" type="text" class="w-full px-5 py-4 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none transition-all text-gray-900" placeholder="Dipolog City">
                </div>
              </div>
              <div>
                <label class="block text-sm font-bold text-gray-700 mb-2">Complete Address</label>
                <textarea v-model="user.address" rows="3" class="w-full px-5 py-4 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none transition-all resize-none text-gray-900" placeholder="Street, Barangay, Building, Door No."></textarea>
              </div>
            </form>
          </div>
          ...
          <div class="bg-white rounded-3xl border border-gray-100 shadow-[0_4px_20px_rgba(0,0,0,0.03)] p-6 sm:p-10">
            <div class="flex items-center justify-between mb-8">
              <h2 class="text-2xl font-bold text-gray-900 flex items-center">
                <span class="w-8 h-8 rounded-full bg-blue-500 text-white text-sm flex items-center justify-center mr-3 font-extrabold shadow-md shadow-blue-500/20">2</span>
                Payment Method
              </h2>
            ...
            <transition name="fade" mode="out-in">
              <div :key="selectedPayment" class="mt-8 bg-gray-50 rounded-2xl p-6 border border-gray-200">
                ...
                <div v-if="['Visa Card', 'MasterCard'].includes(selectedPayment)">
                  ...
                  <div class="space-y-4">
                    <div>
                      ...
                      <input type="text" placeholder="XXXX XXXX XXXX XXXX" class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none transition-all font-mono">
                    </div>
                    <div class="grid grid-cols-2 gap-4">
                      <div>
                        <label class="block text-xs font-bold text-gray-700 mb-1.5">Expiry Date</label>
                        <input type="text" placeholder="MM/YY" class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none transition-all font-mono">
                      </div>
                      <div>
                        <label class="block text-xs font-bold text-gray-700 mb-1.5">CVC</label>
                        <input type="text" placeholder="123" class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none transition-all font-mono">
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div v-else-if="selectedPayment === 'GCash'">
                  ...
                  <input type="tel" placeholder="09XX XXX XXXX" class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none transition-all font-mono">
          ...
          <div class="bg-white rounded-3xl border border-gray-100 shadow-xl p-6 sm:p-8 sticky top-24">
            ...
            <div class="mb-6 border-y border-gray-100 py-6">
              ...
              <div id="flexwrapcoupon" class="eugenerp flex flex-col sm:flex-row gap-2">
                <input v-model="promoInput" type="text" class="flex-1 min-w-0 px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none font-mono uppercase text-gray-900 tracking-wider" placeholder="Ex: CEBU10">
            ...
            <div class="space-y-4 mb-8">
              ...
              <div class="flex justify-between items-center border-t border-gray-100 pt-5">
                ...
                <span class="text-3xl font-extrabold text-blue-500">₱{{ cartStore.total.toFixed(2) }}</span>
              </div>
            </div>
            ...
            <button 
              ...
              class="w-full bg-blue-500 hover:bg-blue-600 text-white font-bold py-4 rounded-xl shadow-lg shadow-blue-500/30 transition-all hover:scale-[1.02] active:scale-95 text-lg flex justify-center items-center disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:scale-100 disabled:shadow-none relative overflow-hidden group"
            >
