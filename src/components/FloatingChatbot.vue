...
<template>
  <div class="fixed bottom-6 right-6 z-[100] flex flex-col items-end">
        ...
        <div ref="messageContainer" class="flex-grow p-4 overflow-y-auto space-y-4 bg-gray-50/50 scroll-smooth">
          ...
          >
            <div 
              ...
              :class="msg.sender === 'user' ? 'bg-blue-500' : 'bg-gradient-to-br from-blue-800 to-blue-700'"
            >
            ...
            <div 
              ...
              :class="msg.sender === 'user' ? 'bg-blue-500 text-white rounded-2xl rounded-br-sm' : 'bg-white text-gray-700 rounded-2xl rounded-bl-sm border border-gray-100'"
            >
              {{ msg.text }}
            </div>
          </div>
        ...
        <div class="p-4 bg-white border-t border-gray-100 shadow-[0_-4px_10px_rgba(0,0,0,0.02)]">
          <form @submit.prevent="sendMessage" class="flex items-center space-x-2">
            ...
            <button 
              ...
              class="bg-blue-500 text-white rounded-full p-2.5 h-10 w-10 flex items-center justify-center shrink-0 hover:bg-blue-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-lg hover:shadow-blue-500/30"
            >
    ...
    <button 
      @click="toggleChat" 
      class="bg-blue-500 hover:bg-blue-600 text-white p-2 rounded-full shadow-xl shadow-coral-500/30 transition-transform transform hover:scale-110 active:scale-95 focus:outline-none flex items-center justify-center relative group"
    >
